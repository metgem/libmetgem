...
SPECTRA_COMPARISONS = {
    ...
    'entropy': {
        (0, 1): (0.02, [(0, 0, 0.6459, 0), (5, 1, 0.0446, 0), (7, 3, 0.0206, 0), (14, 4, 0.0099, 0)]),
        (2, 3): (0.02, [(0, 0, 0.1763, 0), (1, 1, 0.1346, 0), (2, 2, 0.1343, 0), (3, 3, 0.1100, 0), (4, 4, 0.0989, 0),
                        (5, 5, 0.0961, 0), (6, 6, 0.0951, 0), (7, 7, 0.0704, 0), (8, 8, 0.0426, 0), (9, 9, 0.0417, 0)]),
        (4, 5): (0.02, [(0, 1, 0.2962, 0), (2, 4, 0.0576, 1), (1, 6, 0.0560, 0), (6, 3, 0.0336, 1), (18, 0, 0.0219, 1),
                        (17, 5, 0.0178, 1)]),
        (0, 2): (0.02, [])
        },
    'weighted_entropy': {
        (0, 1): (0.02, [(0, 0, 0.3517, 0), (5, 1, 0.0602, 0), (7, 3, 0.0372, 0), (14, 4, 0.0222, 0)]),
        (2, 3): (0.02, [(0, 0, 0.1599, 0), (1, 1, 0.1287, 0), (2, 2, 0.1285, 0), (3, 3, 0.1094, 0), (4, 4, 0.1004, 0),
                        (5, 5, 0.0981, 0), (6, 6, 0.0973, 0), (7, 7, 0.0764, 0), (8, 8, 0.0510, 0), (9, 9, 0.0502, 0)]),
        (4, 5): (0.02, [(0, 1, 0.2283, 0), (2, 4, 0.0641, 1), (1, 6, 0.0617, 0), (6, 3, 0.0442, 1), (18, 0, 0.0375, 1),
                        (17, 5, 0.0282, 1)]),
        (0, 2): (0.02, [])
        }
    }
